...
export interface IStorage {
  ...
  updateParticipantPaymentStatus(participantId: string, status: string): Promise<CompetitionParticipant | undefined>;
  getParticipantById(participantId: string): Promise<CompetitionParticipant | undefined>;
