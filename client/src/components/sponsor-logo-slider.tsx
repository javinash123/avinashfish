          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            {sponsors.map((sponsor) => (
              <button
                ...
                className="flex-shrink-0 transition-all duration-300 grayscale hover:grayscale-0 opacity-60 hover:opacity-100 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-md p-2"
